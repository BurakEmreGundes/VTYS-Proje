...
namespace B191210013
{
    public partial class Form1 : Form
    {
        ...
        public void yetenek_listele()
        {
            ...
            NpgsqlConnection conn = new NpgsqlConnection("Server=localhost; Port=5432; Database=B191210013; User Id=postgres; Password=zorsifre123;");
            conn.Open();
        ...
        {
            NpgsqlConnection connection = new NpgsqlConnection("Server=localhost; Port=5432; Database=B191210013; User Id=postgres; Password=zorsifre123;");
